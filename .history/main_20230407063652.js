...
const app = {
  ...
  onFormSub: reviewForm.addEventListener("submit", (e) => {
    ...
    !e.target.title
      ? reviewForm.addErrorMessage("This field requires a movie selection")
      : !userInput.value
      ? reviewForm.addErrorMessage("Fields can not be empty")
      : (userEntries = document.getElementById("results"));
