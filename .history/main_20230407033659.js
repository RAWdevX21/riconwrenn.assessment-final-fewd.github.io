...
const app = {
  ...
  /*   🔔 EventHandlers
  ╚═════════════════════════════╝*/
  userReview: (reviewForm.addEventListener = (e) => {
    e.preventDefault();
    console.log(e.target.value);
    console.log(reviewForm.querySelector(`input[type="text"]`));
  }),
  userSelection: selectMenu.addEventListener("change", function selection(ev) {
    try {
