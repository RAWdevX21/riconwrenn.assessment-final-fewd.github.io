const app = {
  ...
  displayInfo: function (d) {
    ...
    const section = div.parentElement.outerHTML;
    const origSibling = div.previousElementSibling.outerHTML;
    let h3 = document.createElement("h3");
    h3 = origSibling.replaceWith(h3);

    origSibling.replaceWith(h3);
  },
